...
describe('registration master', () => {
        ...
        test('registration and remove master', async () => {
            ...
            const response3 = await axios.delete(`http://localhost:5000/api/masters/${response2.data.id}`,
        ...
        test('registration master with duplicate email', async () => {
            ...
            let response2
            try {
                response2 = await axios.post(`http://localhost:5000/api/masters`, {
                    name: "NormalLongName", email: "example@gmail.com", citiesId: '[1]',
...
describe('get one master', () => {
    ...
    test('get one master', async () => {
        ...
        const response = await axios.get(`http://localhost:5000/api/getOneMaster/:masterId`)
